...
watch(format, (newFormat) => {
  currentFormat.value =
    formats.find((f) => f.value === newFormat) || formats[0];
      ...
      <div class="control-grid">
        ...
        <div class="input-group">
          ...
          <div class="format-hint">
            ...
            <p class="example">Example: {{ currentFormat.example }}</p>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <input id="width" v-model="width" type="number" min="1" />
        </div>

        <!-- Height Input -->
        <div class="input-group">
          <label for="height">Height:</label>
          <input id="height" v-model="height" type="number" min="1" />
        </div>

        <!-- Text Position -->
        <div class="input-group">
          <label for="text-position">Text Position:</label>
          <select id="text-position" v-model="textPosition">
        ...
        <div class="input-group">
          ...
          <select id="text-align" v-model="textAlign">
        ...
        <div class="input-group">
          ...
          <input id="font-size" v-model="fontSize" type="number" min="1" />
        </div>

        <!-- Margin -->
        <div class="input-group">
          <label for="margin">Margin:</label>
          <input id="margin" v-model="margin" type="number" min="0" />
        </div>

        <!-- Line Color -->
        <div class="input-group">
          <label for="line-color">Line Color:</label>
          <input id="line-color" v-model="lineColor" type="color" />
        </div>
